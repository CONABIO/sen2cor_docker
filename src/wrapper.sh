...
#default values
resolution=10
with_dem=/root/sen2cor/2.8/cfg/L2A_GIPP_without_dem.xml
delete_unzipped=n
...
while true; do
    case "$1" in
        ...
        -r|--resolution)
            ...
            ;;
        -d|--with-dem)
            with_dem=/root/sen2cor/2.8/cfg/L2A_GIPP_with_dem.xml
            shift
            ;;
        -u|--delete-unzipped)
            delete_unzipped=y
...
# Run sen2cor
/Sen2Cor-02.08.00-Linux64/bin/L2A_Process $unzipped_dir --resolution=$resolution --GIP_L2A $with_dem
